...
const PracticeForm = ({ onFormSubmit, ...props }) => {
  ...
  const modalBody = `Please read these terms and conditions carefully before using Our Service.
  ...
  Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Avon Institute.
  ...
  Website refers to Avon Institute, accessible from http://www.avoninstitute.com/
  ...
  By visiting this page on our website: http://www.avoninstitute.com/`;
